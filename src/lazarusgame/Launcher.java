...
import lazarusgame.game.TRE;
import lazarusgame.menus.EndGamePanel;
import lazarusgame.menus.StartMenuPanel;
import lazarusgame.menus.WonAllLevelsPanel;
...
public class Launcher {
    ...
    /*
     * won panel is used to show the won game panel.  it will contain
     * one buttons 'exit' and congrats message!.
     */
    ...
    public Launcher(){
        ...
        this.jf.setTitle("Lazarus Game"); // setting the title of the JFrame window.
    ...
    public void initUIComponents(){
        ...
        this.wonPanel = new WonAllLevelsPanel(this); // create a new won the game panel
        ...
        this.mainPanel.add(gamePanel, "lazarusgame/game");   //add the game panel to the main panel
        this.mainPanel.add(endPanel, "end");    // add the end game panel to the main panel
        this.mainPanel.add(wonPanel, "won");
    ...
    public void setFrame(String type){
        ...
        switch(type){
            ...
            case "end":
                ...
                break;
            case "won":
                this.jf.setSize(GameConstants.WON_MENU_SCREEN_WIDTH,GameConstants.WON_MENU_SCREEN_HEIGHT);
                break;
        }
